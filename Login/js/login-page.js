...
checkStudentInfo = function() {
    ...
    var url = '/Login/php/verifyStudentLogin.php';
    var method = 'POST';
    ...
    http.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200){
            ...
            if(studentID) {
                ...
                window.location.replace("/Student/Main/html/studentMain.html");
            } else {
...
checkAdminInfo = function() {
    ...
    var http = new XMLHttpRequest();
    var url = '/Login/php/verifyAdminLogin.php';
    var method = 'POST';
    ...
    http.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200){
            ...
            if(adminID) {
                ...
                window.location.replace("/Admin/php/Main/admin_page.php");
            } else {
                //Update the error message to say Login Unsuccessful
